...
;;Implementación del algoritmo voraz principal este recibe una matriz de tipo M y N donde se aplica una función de minmax de profundidad 1, además se evalúa los candidatos en la función minmax.
...
;;Este posee una profundidad de 1 es decir va a observar las opciones de cuales soluciones son las mas ideales pero que tenga una profundidad 1 es decir que estén al menos una 1 posición de adelanto. 
